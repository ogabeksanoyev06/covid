...
import Tab3 from "@/views/site/modules/moduleSeven/tab-content/tab-3.vue";
import Tab4 from "@/views/site/modules/moduleSeven/tab-content/tab-4.vue";
import Tab5 from "@/views/site/modules/moduleSeven/tab-content/tab-5.vue";
import Tab6 from "@/views/site/modules/moduleSeven/tab-content/tab-6.vue";
import Tab7 from "@/views/site/modules/moduleSeven/tab-content/tab-7.vue";
export default {
  name: "detailedPage",
  components: {
    Accordion,
      ...
      sectionContentTree: [
        {
          ...
          contentList: [
            ...
            {
              id: 4,
              name: " Принципы конфиденциальности и безопасности информации о ВИЧ",
            },
            {
              id: 5,
              name: "Законы РУз, регулирующие права пациентов и населения:",
            },
          ],
        },
      ],
