        ...
        <div class="sidebar">
          <div class="module__accordion">
            <p class="sidebar__title">
              МОДУЛЬ 2. COVID-19 - новая респираторная инфекция
            </p>
            <div class="divider" />
...
import Tab2 from "@/views/site/modules/moduleTwo/tab-content/tab-2.vue";
import Tab3 from "@/views/site/modules/moduleTwo/tab-content/tab-3.vue";
import Tab4 from "@/views/site/modules/moduleTwo/tab-content/tab-4.vue";
import Tab5 from "@/views/site/modules/moduleTwo/tab-content/tab-5.vue";
import Tab6 from "@/views/site/modules/moduleTwo/tab-content/tab-6.vue";
      ...
      sectionContentTree: [
        ...
        },
        {
          ...
          contentList: [
            ...
            {
              id: 4,
              name: "Категории граждан, которые должны пройти полный курс вакцинации:",
            },
          ],
        },
        {
