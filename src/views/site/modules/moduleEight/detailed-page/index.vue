    ...
    <div class="container">
      ...
      <div class="content">
        ...
        <div class="content__main">
          ...
          <tab-8 v-show="isActive(7)" />
          <tab-9 v-show="isActive(8)" />
          <tab-10 v-show="isActive(9)" />
          <div>
...
import Tab2 from "@/views/site/modules/moduleEight/tab-content/tab-2.vue";
import Tab3 from "@/views/site/modules/moduleEight/tab-content/tab-3.vue";
...
import Tab6 from "@/views/site/modules/moduleEight/tab-content/tab-6.vue";
import Tab7 from "@/views/site/modules/moduleEight/tab-content/tab-7.vue";
import Tab8 from "@/views/site/modules/moduleEight/tab-content/tab-8.vue";
import Tab9 from "@/views/site/modules/moduleEight/tab-content/tab-9.vue";
import Tab10 from "@/views/site/modules/moduleEight/tab-content/tab-10.vue";
      ...
      sectionContentTree: [
        {
          ...
          contentList: [
            ...
            {
              id: 2,
              name: "Навыки, необходимые для уверенного общения",
            },
            {
              id: 3,
              name: "Принципы эффективной коммуникации в условиях пандемии COVID-19",
            },
          ],
        },
        {
          ...
          contentList: [
            ...
            {
              id: 7,
              name: "Открытые и закрытые вопросы",
            },
            {
              id: 8,
              name: "Влияние факторов внешней среды",
            },
            {
              id: 9,
              name: "Выражение негативных чувств",
            },
          ],
        },
      ],
