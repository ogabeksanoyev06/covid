      ...
      <div class="content">
        <div class="sidebar">
          <div class="module__accordion">
            <p class="sidebar__title">МОДУЛЬ 6: COVID-19 И ПРАВА ЧЕЛОВЕКА</p>
            <div class="divider" />
...
import Tab2 from "@/views/site/modules/moduleSix/tab-content/tab-2.vue";
import Tab3 from "@/views/site/modules/moduleSix/tab-content/tab-3.vue";
import Tab4 from "@/views/site/modules/moduleSix/tab-content/tab-4.vue";
import Tab5 from "@/views/site/modules/moduleSix/tab-content/tab-5.vue";
...
import Tab8 from "@/views/site/modules/moduleSix/tab-content/tab-8.vue";
import Tab9 from "@/views/site/modules/moduleSix/tab-content/tab-9.vue";
export default {
  name: "detailedPage",
  components: {
    Accordion,
      ...
      sectionContentTree: [
        ...
        },
        {
          ...
          contentList: [
            ...
            {
              id: 3,
              name: "Право на здоровье и доступ к здравоохранению",
            },
            {
              id: 4,
        ...
        },
        {
          ...
          contentList: [
            ...
            {
              id: 7,
              name: "Защита здоровья населения",
            },
            {
              id: 8,
