        ...
        <div class="sidebar">
          <div class="module__accordion">
            <p class="sidebar__title">
              МОДУЛЬ 5.ОКАЗАНИЕ ПОМОЩИ ЖЕНЩИНАМ С COVID-19 ВО ВРЕМЯ БЕРЕМЕННОСТИ
              И ПОСЛЕ РОДОВ
            </p>
            <div class="divider" />
...
import Tab2 from "@/views/site/modules/moduleFive/tab-content/tab-2.vue";
